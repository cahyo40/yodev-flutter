...
class InitGenerator {
  ...
  void _addDependencies(StateManagement stateManagement) {
    ...
    final commonDeps = {
      ...
      // ─────────────────────────────────────────────────────────────────────
      // NOTE: Deps di bawah TIDAK perlu ditambahkan karena sudah ada
      // di yo_ui (transitive dependency):
      //   cached_network_image, connectivity_plus, device_info_plus,
      //   image_picker, intl, photo_view, google_fonts, fl_chart,
      //   file_picker, font_awesome_flutter, crypto
      // ─────────────────────────────────────────────────────────────────────
    };
